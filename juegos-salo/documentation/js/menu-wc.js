...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">juegos-salo documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/ConsolaSys.html" data-type="entity-link" >ConsolaSys</a>
                            </li>
                            <li class="link">
                                <a href="components/CuentaUsuario.html" data-type="entity-link" >CuentaUsuario</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/LoginSys.html" data-type="entity-link" >LoginSys</a>
                            </li>
                            <li class="link">
                                <a href="components/ModificarPerfil.html" data-type="entity-link" >ModificarPerfil</a>
                            </li>
                            <li class="link">
                                <a href="components/RecuperaContra.html" data-type="entity-link" >RecuperaContra</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/JsonFile.html" data-type="entity-link" >JsonFile</a>
                                </li>
                                <li class="link">
                                ...
                                <li class="link">
                                    <a href="injectables/UsuarioSysService.html" data-type="entity-link" >UsuarioSysService</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="guards-links"' : 'id="xs-guards-links"' }>
                            ...
                            <li class="link">
                                <a href="guards/authSysGuard.html" data-type="entity-link" >authSysGuard</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/UsuarioSys.html" data-type="entity-link" >UsuarioSys</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
