...
export class ProductoService {
    private productos : Producto[] = [
        ...
        { id: 8, categoriaId: 3, nombre: 'Magic: The Gathering', descripcion: 'Un juego de cartas coleccionables donde los jugadores asumen el papel de poderosos magos que luchan entre sí.', precio: 29990, precioAnterior: 32990, imagen: '/img/cat3_dbz.png' },
